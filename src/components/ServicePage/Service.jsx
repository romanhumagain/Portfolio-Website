const Service = ({ service }) => {
  return (
    <>
      <div className="flex flex-col w-full max-w-[400px] gap-2 p-3 px-3 transition-transform duration-700 shadow-md md:p-5 bg-gradient-to-l from-slate-100 to-slate-300 dark:from-neutral-800 dark:to-neutral-900 item-start rounded-2xl hover:scale-105">
