      ...
      <div
        ...
        >
          <motion.h1
            ...
            className="text-5xl font-bold text-center text-transparent bg-opacity-50 md:text-7xl bg-clip-text bg-gradient-to-b from-purple-500 via-pink-700 to-purple-300"
