...
const Navbar = ({ homeRef, aboutRef, skillsRef, expertiseRef, projectsRef, certificatesRef, scrollToSection }) => {
  ...
  return (
    <>
      <div className={`fixed ${!isContactModalOpen && 'z-50'} flex justify-center w-full max-w-2xl px-3 py-3 my-5 rounded-full shadow-md bg-gradient-to-r from-slate-100 via-slate-200 to-slate-300 dark:from-neutral-700 dark:via-neutral-800 dark:to-neutral-800`}>
